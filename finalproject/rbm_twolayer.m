...
for i=1:numSGDsteps
    ...
    hiddenbatch = sigmoid(repmat(b,minibatchsize,1) + visbatch*W);
    ...
    hiddenbatch = binornd(1,sigmoid(repmat(b,minibatchsize,1) + visbatch*W));
    for j = 1:cdsteps        
...
epocherrors_rbm = [epocherrors_rbm epoch_error];
fprintf(1, 'epoch %d error %6.4f  \n', epoch, epoch_error); 
end
stack.W =W;
stack.a =a;
stack.b =b;
%save epocherrors_rbm;
end
